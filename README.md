...
4. **Configuration:**
   ...
   - After that change "YOUR_BOT_TOKEN_HERE" to your bot token, "YOUR_BOT_ID_HERE" to your bot id and "YOUR_POSTGRES_URL_HERE" with your direct url connection to postgres database in `config.json`
...
- If you want to understand how the bot works, well here it is, hopefully it is understandable. There are comments in the code when and where it gets complicated. Suggestions before reading the commands? Start from `commands/templates/ping.js` or for slash commands `commands-slash/help.js`. Also read: [Discord.JS docs](https://discord.js.org/docs/packages/discord.js/14.26.4) AND [Discord Player docs](https://discord-player.js.org/) not to mention [Node Postgres](https://node-postgres.com/)
...
- **`loader.js`**:
  ...
  - In order, the _loader loads_:
    - the connection to the remote database with **Node PG**
...
- You can contribute to the project by, submiting pull requests OR the best thing to do, is to invite the bot to your Discord server and find any bugs, bot invite link: [invite link](https://discord.com/api/oauth2/authorize?client_id=878594739744673863&permissions=2080948874566&scope=bot)
...
- Join the Discord server: [join](https://discord.gg/KxadTdz) and follow me on all of my socials: [youtube](https://www.youtube.com/@pier77repeter)

## Credits

- Myself, achernar67 for testing and YOU for inviting the Bot!
